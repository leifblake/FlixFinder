...
const Footer = () => {
  return (
    <footer className="bg-[#020014] text-white font-dm-sans py-8">
      <div className="max-w-7xl mx-auto px-5 sm:px-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Section 1: Branding */}
          <div className="space-y-4">
            <h3 className="text-xl font-bold">FlixFinder</h3>
            <p className="text-sm text-gray-300">
              &copy; 2025, Designed by Leif Blake
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li>
                <a
                  href="https://github.com/leifblake"
                  target="_blank"
              ...
              <li>
                <a
                  href="https://www.instagram.com/leifalexandriaa/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-gray-300 hover:text-white transition-colors"
                >
          ...
          {/* Section 3: Credits */}
          <div className="space-y-4">
            <h4 className="text-lg font-semibold">Credits</h4>
            <p className="text-sm text-gray-300">
              Created using Appwrite Database, TMDB
            </p>
          </div>
